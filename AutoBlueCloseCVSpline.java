...
@Autonomous
public class AutoBlueCloseCVSpline extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory moveSplineCenter = drive.trajectoryBuilder(moveBackCenter.end())
                .splineTo(new Vector2d(41, 34.435), Math.toRadians(0))
                .build();
        ...
        Trajectory moveSplineLeft = drive.trajectoryBuilder(moveBackLeft2.end())
                .lineToSplineHeading(new Pose2d(41, 42.15, Math.toRadians(0)))
                .build();
        ...
        Trajectory moveBackRight2 = drive.trajectoryBuilder(moveStrafeRightLeft.end())
                .back(8)
                .build();

        Trajectory moveSplineRight = drive.trajectoryBuilder(moveBackRight2.end())
                .splineTo(new Vector2d(41, 27.51), Math.toRadians(0))
                .build();
